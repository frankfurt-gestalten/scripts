...
class XMLProcessingTest(unittest.TestCase):
    ...
    def testOutputDoesNotContainMultipleKoordinatesForOneVerortungselement(self):
        ...
        '        <MeldungsTextKurz/>',
                '<MeldungsTextLang>Messe/Rebstock Max-Pruss-Straße Wegen der Heimtextil-Messe ist die ,Verkehrsf�hrung im Rebstockgelände wegen der Messeanfahrt und -abfahrt geändert. Es ist mit Verkehrs- behinderungen zu rechnen. Von 8. bis 11.1.2014.</MeldungsTextLang>',
        ...
        '                </Koordinaten>',
        '            </Verortungselement>',
        '            <Verortungselement Index="31" Typ="Kante">',
        '                <Koordinaten Index="0">',
        '                    <X-Koordinate>3472120,05</X-Koordinate>',
        '                    <Y-Koordinate>5552985,36</Y-Koordinate>',
        '                </Koordinaten>',
        '            </Verortungselement>',
        '            <Verortungselement Index="37" Typ="Kante">',
        '                <Koordinaten Index="0">',
        '                    <X-Koordinate>3472503,33</X-Koordinate>',
        '                    <Y-Koordinate>5553085,64</Y-Koordinate>',
        '                </Koordinaten>',
        '            </Verortungselement>',
        '            <Verortungselement Index="46" Typ="Kante">',
        '                <Koordinaten Index="0">',
        '                    <X-Koordinate>3471364,00</X-Koordinate>',
        '                    <Y-Koordinate>5552830,98</Y-Koordinate>',
        '                </Koordinaten>',
        '            </Verortungselement>',
        '        </Verortung>',
        '    </Ereignis>',
        ...
        '        <MeldungsTextKurz/>',
        '<MeldungsTextLang>Rebstockgelände Theodor-Heuss-Allee Vom 8. - 11.1. Messe. Es ist mit ,erhöhten Verkehrsaufkommen zu rechnen! Besucher werden gebeten bei der Anfahrt keine Navigations- geräte zu benutzen, sondern der Messebeschilderung zu folgen!</MeldungsTextLang>',
        ...
        expected_result = [
            ...
            '        <MeldungsTextKurz/>',
            '<MeldungsTextLang>Messe/Rebstock Max-Pruss-Stra\xc3\x9fe Wegen der Heimtextil-Messe ist die ,Verkehrsf\xef\xbf\xbdhrung im Rebstockgel\xc3\xa4nde wegen der Messeanfahrt und -abfahrt ge\xc3\xa4ndert. Es ist mit Verkehrs- behinderungen zu rechnen. Von 8. bis 11.1.2014.</MeldungsTextLang>',
            '        <ZeitraumVon>06.01.2014 15:25:26</ZeitraumVon>',
            '        <ZeitraumBis>11.01.2014 20:00:00</ZeitraumBis>',
            '        <Phrasecode/>',
            '        <AlertCNr>1854</AlertCNr>',
            ...
            '        <Text>Heimtextil 8. bis 11.1.</Text>',
            '        <MeldungsTextKurz/>',
            '<MeldungsTextLang>Rebstockgel\xc3\xa4nde Theodor-Heuss-Allee Vom 8. - 11.1. Messe. Es ist mit ,erh\xc3\xb6hten Verkehrsaufkommen zu rechnen! Besucher werden gebeten bei der Anfahrt keine Navigations- ger\xc3\xa4te zu benutzen, sondern der Messebeschilderung zu folgen!</MeldungsTextLang>',
            '        <ZeitraumVon>06.01.2014 15:22:15</ZeitraumVon>',
            '        <ZeitraumBis>11.01.2014 20:00:00</ZeitraumBis>',
            '        <Phrasecode/>',
            '        <AlertCNr>1469</AlertCNr>',
            ...
            '            <Verortungselement Index="0" Typ="Kante">',
            '                <Koordinaten Index="0">',
            '                    <X-Koordinate>50.1110079346</X-Koordinate>',
            '                    <Y-Koordinate>8.59861348269</Y-Koordinate>',
